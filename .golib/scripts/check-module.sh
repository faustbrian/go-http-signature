...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-http-signature" &&
                "${module_path}" != github.com/faustbrian/go-http-signature/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-http-signature"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
