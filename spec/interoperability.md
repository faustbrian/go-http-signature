...
The interoperability portion of `make check` fetches the exact commits into
disposable directories, runs the selected peer suites and shared corpus with disposable Go
